<div class="info-panel" style="padding-top: 10px; max-height: 350px; overflow-y: scroll;">
    ...
    <ul id="packetInfoList" data-role="listview" data-inset="true">
        <li data-role="list-divider" style="min-height: 40px; color: darkorange">
            ...
            <span>
                <a style="margin-left: 30px;" href="#packetInfo" data-rel="popup" data-position-to="window" data-transition="pop" class="ui-btn ui-btn-inline ui-mini neon-shadow-light" data-icon="power">
