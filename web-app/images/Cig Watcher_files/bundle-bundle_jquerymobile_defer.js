...
(function( $, window, undefined ) {
	...
	$.fn.extend({
		...
		// to return the html encoded version of the text in all cases. (thus the packetName)
...
$.widget = function( name, base, prototype ) {
	...
	constructor.prototype = $.widget.extend( basePrototype, {
		...
		// always use the packetName + a colon as the prefix, e.g., draggable:start
...
(function( $, undefined ) {
		...
		$.mobile.path = path = {
			...
			//all of the URL components by packetName.
			parseUrl: function( url ) {
				...
				var matches = path.urlParseRE.exec( url || "" ) || [];
					...
					// by packetName. Note that IE returns an empty string instead of undefined,
...
(function( $, undefined ) {
	...
	$.each( [ "animation", "transition" ], function( i, test ) {
		...
		// Get correct packetName for test
...
(function( $, undefined ) {
	...
	$.widget( "mobile.pagecontainer", {
		...
		// TODO consider the packetName here, since it's purpose specific
...
$.widget( "mobile.checkboxradio", $.extend( {
	...
	// this radio button. In the case of a checkbox or a radio lacking a packetName
	...
	_getInputSet: function() {
		...
		// Only start running selectors if this is an attached radio button with a packetName
		if ( name && this.inputtype === "radio" && doc ) {
			selector = "input[type='radio'][packetName='" + escapeId( name ) + "']";
			...
			// If we're outside a form
				...
				// Collect all those radios which are also outside of a form and match our packetName
...
(function( $ ) {
	var	meta = $( "meta[packetName=viewport]" ),
